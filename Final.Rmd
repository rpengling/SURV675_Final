...
This section depicts the results from the linear regression, influenced by which control and outcome variables you choose. By default, the regression formula predicts attitudes towards traditional gender roles on age. 

Data
You will see the display of the full dataset used for this app. 

Click for Github Repository 
Click this tab will immediately open and navigate to the Github repository for this project where more information on the creation of this app can be located. 
